...
const TCHAR* const kRegValueServiceName           = _T("usaa_service_name");
const TCHAR* const kRegValueMediumServiceName     = _T("usaam_service_name");
const TCHAR* const kRegValueTaskNameC             = _T("usaa_task_name_c");
const TCHAR* const kRegValueTaskNameUA            = _T("usaa_task_name_ua");
...
const TCHAR* const kServicePrefix               = _T("usaa");
const TCHAR* const kMediumServicePrefix         = _T("usaam");
